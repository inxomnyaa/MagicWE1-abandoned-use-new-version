	...
	public function onCommand(CommandSender $sender, Command $command, string $label, array $args): bool {
		if ($sender instanceof Player) {
			switch ($command) {
				...
				case "/pos2": {
					if (!$sender->hasPermission("we.command.pos2") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/set": {
					if (!$sender->hasPermission("we.command.set") && !$sender->hasPermission("we.command.admin")) return true;
					if (isset($args[0])) {
				...
				case "/replace": {
					if (!$sender->hasPermission("we.command.replace") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/copy": {
					if (!$sender->hasPermission("we.command.copy") && !$sender->hasPermission("we.command.admin")) return true;
					if (isset($this->pos1[$sender->getName()], $this->pos2[$sender->getName()])) {
						$this->copy($sender);
						return true;
					}
				...
				case "/paste": {
					if (!$sender->hasPermission("we.command.paste") && !$sender->hasPermission("we.command.admin")) return true;
					if (isset($this->pos1[$sender->getName()], $this->pos2[$sender->getName()])) {
						$this->paste($sender);
						$sender->getLevel()->doChunkGarbageCollection();
						return true;
				...
				case "/undo": {
					if (!$sender->hasPermission("we.command.undo") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/redo": {
					if (!$sender->hasPermission("we.command.redo") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/flip": {
					if (!$sender->hasPermission("we.command.flip") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "toggleeditwand":
				case "/wand": {
					if (!$sender->hasPermission("we.command.wand") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/schem": {
					if (!$sender->hasPermission("we.command.schem") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/cyl": {
					if (!$sender->hasPermission("we.command.cyl") && !$sender->hasPermission("we.command.admin")) return true;
				...
				case "/hcyl": {
					if (!$sender->hasPermission("we.command.hcyl") && !$sender->hasPermission("we.command.admin")) return true;
					if (isset($args[0], $args[1])) {
						#$this->fill($sender, $args[0]);
